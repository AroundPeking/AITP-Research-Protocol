...
def test_final_readiness_audit_keeps_kernel_capability_separate_from_content_backlog(tmp_path):
    ...
    assert payload["kernel_capabilities"]["source_stack"]["coverage_manifest_surface"] == (
        "source_stack_coverage_manifest"
    )
    assert payload["kernel_capabilities"]["source_stack"]["host_refresh_review_view_supported"] is True
    assert payload["kernel_capabilities"]["source_stack"]["host_refresh_coverage_manifest_supported"] is True
    ...
    assert payload["kernel_capabilities"]["long_term_replay"]["legacy_semantic_repair_surface"] == (
    ...
    assert payload["kernel_capabilities"]["long_term_replay"]["legacy_source_reconstruction_view_surface"] == (
    ...
    assert payload["kernel_capabilities"]["long_term_replay"]["legacy_human_checkpoint_backlog_surface"] == (
    ...
    assert payload["kernel_capabilities"]["natural_interaction"]["recording_worklist_surface"] == (
    ...
    assert payload["kernel_capabilities"]["natural_interaction"]["host_refresh_worklist_supported"] is True
...
def test_final_readiness_cli_compact_progress(tmp_path, capsys):
    ...
    assert cli_payload["source_stack"] == {
