...
def _shared_pre_tool_policy_lines() -> list[str]:
    return [
        ...
        "- optional inputs include: `evidence_refs`, `code_state_ids`, `validation_contract_ids`, `tool_run_ids`, `validation_result_ids`, `known_failure_modes`, `source_kind`, `source_ref`, `orientation_only`, `human_checkpoint_id`, `failure_mode_review_result_id`",
        "",
    ]
...
def _adapter_pre_tool_event_lines(*, runner: dict[str, Any], entrypoint: dict[str, Any]) -> list[str]:
    return [
        ...
        "- platform event optional tool inputs include: `claim_id`, `evidence_refs`, `code_state_ids`, `validation_contract_ids`, `tool_run_ids`, `validation_result_ids`, `known_failure_modes`, `packet`, `source_kind`, `source_ref`, `orientation_only`, `risk_level`, `human_checkpoint_id`, `failure_mode_review_result_id`",
        "",
        "```powershell",
