...
def add_adapter_parser(sp) -> None:
    ...
    arp.add_argument("--connector", default="curated_rag", dest="connector_id")
    arp.add_argument("--intent", default="claim_support_review", dest="promotion_intent")
    ...
    ahp.add_argument("--run-lifecycle-smoke", action="store_true"); ahp.add_argument("--lifecycle-command", default="")
    ahp.add_argument("--lifecycle-arg", action="append", default=[], dest="lifecycle_args")
...
def dispatch_adapter_command(args: Namespace, ws: Any | None) -> dict[str, Any]:
    ...
    if args.adapter_command == "curated-rag-promotion-draft":
        return {
            "ok": True,
        ...
        return {
            ...
            **require_valid_public_surface(
                ...
                audit_priority_host_production_loops(
                    ...
                    lifecycle_command=args.lifecycle_command,
                    lifecycle_args=args.lifecycle_args or None,
                ),
            ),
        }
