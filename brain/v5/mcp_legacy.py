...
def aitp_v5_build_legacy_semantic_needs_revision_basis_packet(base: str, *, migration_dir: str, topic: str) -> dict:
    result = build_legacy_semantic_needs_revision_basis_packet(
        _ws(base),
        migration_dir=migration_dir,
        topic=topic,
    )
    return {"ok": True, **require_valid_public_surface("legacy_semantic_needs_revision_basis_packet", result)}


def aitp_v5_write_legacy_semantic_needs_revision_basis_obsidian_view(
    base: str,
    *,
    migration_dir: str,
    output_dir: str = "",
) -> dict:
    result = write_legacy_semantic_needs_revision_basis_obsidian_view(
        _ws(base),
        migration_dir=migration_dir,
        output_dir=output_dir,
    )
    return {"ok": True, **require_valid_public_surface("legacy_semantic_needs_revision_basis_obsidian_view_bundle", result)}
...
def aitp_v5_write_legacy_semantic_review_obsidian_view(
    ...
    *,
    ...
    result = write_legacy_semantic_review_obsidian_view(
        _ws(base),
        migration_dir=migration_dir,
        output_dir=output_dir,
    )
    return {"ok": True, **require_valid_public_surface("legacy_semantic_review_obsidian_view_bundle", result)}
...
def aitp_v5_build_legacy_semantic_repair_manifest(base: str, *, migration_dir: str) -> dict:
    result = build_legacy_semantic_repair_manifest(_ws(base), migration_dir=migration_dir)
    return {"ok": True, **require_valid_public_surface("legacy_semantic_repair_manifest", result)}
...
def aitp_v5_build_legacy_human_checkpoint_packet(
    base: str,
    *,
    migration_dir: str,
    topic: str = "",
