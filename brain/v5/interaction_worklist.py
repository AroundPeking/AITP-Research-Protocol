...
def _work_item(preview_item: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "can_continue_without_kernel_write": mode != "trust_boundary_checkpoint",
        "max_questions": int(preview_item.get("max_questions") or 0),
        "heavier_triggers": list(preview_item.get("heavier_triggers") or []),
