...
def main() -> int:
    ...
    check(discussion_bundle["runtime_mode"] == "explore", "Expected demo-discussion to materialize explore mode.")
    check("topics/demo-discussion/runtime/operator_checkpoint.active.md" in discussion_must_read, "Expected explore mode to foreground the active operator checkpoint.")
    check("topics/demo-discussion/runtime/idea_packet.md" in discussion_must_read, "Expected explore mode to foreground the idea packet.")
    check("topics/demo-discussion/runtime/validation_review_bundle.active.md" not in discussion_must_read, "Explore mode must defer validation review.")
    check("topics/demo-discussion/runtime/validation_review_bundle.active.md" in discussion_deferred, "Explore mode must defer validation review into the deferred set.")
    check("topics/demo-discussion/runtime/promotion_readiness.md" in discussion_deferred, "Explore mode must defer promotion readiness.")
    ...
    check(verify_bundle["runtime_mode"] == "learn", "Expected demo-verify to materialize learn mode.")
    check("topics/demo-verify/runtime/validation_review_bundle.active.md" in verify_must_read, "Learn mode must foreground validation review.")
    check("topics/demo-verify/runtime/validation_contract.active.md" in verify_must_read, "Learn mode must foreground validation contract.")
    check("topics/demo-verify/runtime/selected_validation_route.md" in verify_must_read, "Learn mode must foreground the selected validation route.")
    check("topics/demo-verify/runtime/execution_task.md" in verify_must_read, "Learn mode must foreground the execution task surface.")
    check("topics/demo-verify/runtime/promotion_readiness.md" in verify_deferred, "Learn mode must defer promotion readiness.")
    check("verification_route_selection" in verify_active_triggers, "Learn mode must keep verification_route_selection active.")
    check("formal_theory_upstream_scan" not in verify_active_triggers, "Learn mode must suppress unrelated formal_theory_upstream_scan triggers.")
    ...
    check(promote_bundle["runtime_mode"] == "implement", "Expected demo-promote to materialize implement mode.")
    check("topics/demo-promote/runtime/promotion_readiness.md" in promote_must_read, "Implement mode must foreground promotion readiness.")
    check("topics/demo-promote/runtime/promotion_gate.md" in promote_must_read, "Implement mode must foreground the promotion gate.")
    check("topics/demo-promote/runtime/control_note.md" not in promote_must_read, "Implement mode must defer unrelated control-note history.")
    check("topics/demo-promote/runtime/control_note.md" in promote_deferred, "Implement mode must defer unrelated control-note history.")
    check("promotion_intent" in promote_active_triggers, "Implement mode must keep promotion_intent active.")
    check("verification_route_selection" not in promote_active_triggers, "Implement mode must suppress verification-route triggers.")
    check("formal_theory_upstream_scan" not in promote_active_triggers, "Implement mode must suppress unrelated formal_theory_upstream_scan triggers.")
