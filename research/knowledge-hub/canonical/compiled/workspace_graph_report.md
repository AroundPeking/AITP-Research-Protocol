...
- `theorem:jones-ch4-finite-product` Jones Chapter 4 Finite-Product Block-Centralizer Type-I Packet [[derived_navigation/theorem_card--jones-ch4-finite-product|Jones Chapter 4 Finite-Product Block-Centralizer Type-I Packet]]
- `topic_skill_projection:fresh-jones-finite-dimensional-factor-closure` Fresh Jones Finite Dimensional Factor Closure Topic Skill Projection [[derived_navigation/topic_skill_projection--fresh-jones-finite-dimensional-factor-closure|Fresh Jones Finite Dimensional Factor Closure Topic Skill Projection]]
