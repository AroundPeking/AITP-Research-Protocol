...
- `staging:hs-model-otoc-lyapunov-exponent-regime-mismatch` HS model OTOC Lyapunov exponent: regime mismatch (`non_authoritative_staging`)
...
- `proof_fragment:jones-codrestrict-comp-subtype-construction-recipe` Jones codRestrict + subtype composition construction recipe [authoritative_canonical/trusted/added] `canonical/proof-fragments/proof_fragment--jones-codrestrict-comp-subtype-construction-recipe.json`
...
- `staging:hs-model-otoc-lyapunov-exponent-regime-mismatch` HS model OTOC Lyapunov exponent: regime mismatch [non_authoritative_staging/contradiction_watch/added] `canonical/staging/entries/staging--hs-model-otoc-lyapunov-exponent-regime-mismatch.json`
...
- `staging:phase138-test-contradiction-aitp-cli-e2e-beo7dvwo` Phase138 test contradiction aitp-cli-e2e-beo7dvwo [non_authoritative_staging/contradiction_watch/unchanged] `canonical/staging/entries/staging--phase138-test-contradiction-aitp-cli-e2e-beo7dvwo.json`
...
- `staging:weak-coupling-tfim-picture` Weak-coupling TFIM picture [non_authoritative_staging/provisional/updated] `canonical/staging/entries/staging--weak-coupling-tfim-picture.json`
